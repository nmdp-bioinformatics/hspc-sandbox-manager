...
export AWS_TASK_CPU_UNIT=256
export AWS_TASK_MEMORY_UNIT=512
export AWS_CONTAINER_NAME="$1-$2"
export AWS_CONTAINER_PORT=8080
export AWS_CONTAINER_CPU_UNIT=256
export AWS_CONTAINER_MEMORY_UNIT=512
...
export IMAGE_COORDINATES="hspconsortium/hspc-sandbox-manager:2.8.0-SNAPSHOT"
export IMAGE_COORDINATES_ESCAPED="hspconsortium\/hspc-sandbox-manager:2\.8\.0-SNAPSHOT"
