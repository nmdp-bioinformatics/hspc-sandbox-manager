...
INSERT INTO client_redirect_uri (owner_id, redirect_uri) VALUES
  ((SELECT id from client_details where client_id = 'sand_man'), 'http://localhost:8080/hsp-sandbox-manager'),
  ((SELECT id from client_details where client_id = 'sand_man'), 'http://54.213.219.198:9080/uat/hsp-sandbox-manager'),
  ((SELECT id from client_details where client_id = 'sand_man'), 'https://sandbox.hspconsortium.org/hsp-sandbox-manager');
